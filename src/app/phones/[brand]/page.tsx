    ...
    <div className="bg-slate-50 min-h-screen py-12 lg:py-20">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="bg-white p-8 lg:p-12 rounded-3xl shadow-sm border border-slate-200 mb-12 text-center max-w-4xl mx-auto">
          <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 flex items-center justify-center relative overflow-hidden mb-6 mx-auto">
            {brandData.logo_url ? (
              <Image 

...
export default function DeletePhoneButton({ id }: { id: string }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full z-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Delete Phone?</h3>
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                This action is permanent and cannot be undone. The phone will be removed from the site immediately.
              </p>
